/*(c) Ger Versluis 2000 version simple 24 April 2003
...
function RePos(){
	...
	if(MenuCentered.indexOf("justify")!=-1&&FirstLineHorizontal){
		...
		for(i=0;i<NoOffFirstLineMenus;i++){
			...
			if(P.ai)P.ai.style.left=W-Arrws[4]-2+P_X;
			P=P.PrvMbr}}
	StaticPos=-1;
...
function Initiate(){
	if(IniFlg&&Ldd){Init(FrstCntnr);IniFlg=0;if(ShwFlg)AfterCloseAll();ShwFlg=0}}
